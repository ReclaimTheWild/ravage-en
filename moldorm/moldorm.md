...
Moldorm like to rove in areas with pits, spikes, or other tricky traps. They will run into foes headlong, and try to bounce them into dangerous terrain.


<table class="creature-table">
  <thead>
    <tr>
      <th colspan="6" class="fs-6 text-grey-lt-000 creature-title-bg">Moldorm</th>
    </tr>
    <tr>
    ...
    <tr>
      <td class="text-grey-dk-300 creature-content-bg-light" colspan="6">Movement: 6 (Walking)</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="text-grey-dk-300 creature-content-bg-light" colspan="3" rowspan="2">Damage: 3</td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="text-grey-dk-300 creature-content-bg-light fs-2" colspan="6">You enter the square the foe left. Roll To-Hit Target’s Vitality; on success, target is Pushed 1 square in a direction of your choice and Knocked Prone.</td>
    </tr>
    <tr>
      <td class="text-grey-dk-300 creature-content-bg-light" colspan="3">
        <strong>Uppercut</strong>
      </td>
      <td class="text-grey-dk-300 creature-content-bg-light" colspan="3">Damage: 10</td>
    </tr>
    <tr class="text-grey-dk-300 creature-content-bg-light">
      <td class="text-grey-dk-300 creature-content-bg-light" colspan="3">4 Stamina</td>
      <td class="text-grey-dk-300 creature-content-bg-light" colspan="3">Range: Melee</td>
    ...
    <tr>
      <td class="text-grey-dk-300 creature-content-bg-light fs-2" colspan="6">Roll To-Hit target’s Vitality; on success, push the target away from you one square.</td>
    </tr>
    <tr>
      <td class="text-grey-dk-300 creature-content-bg-dark" colspan="6">
        <strong>Default Weapon: </strong>Moldorm Tail
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="text-grey-dk-300 creature-content-bg-light fs-2" colspan="6">When this creature is struck with a melee attack, the attacker is pushed back 3 squares after the attack.</td>
    </tr>
    <tr>
      <td class="text-grey-dk-300 creature-content-bg-dark fs-4" colspan="6">Instinctive Intelligence</td>
    </tr>
    <tr>
      <td class="text-grey-dk-300 creature-content-bg-dark fs-4" colspan="6">Immunity: Forced Movement, Slick Terrain</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="text-grey-dk-300 creature-content-bg-light" colspan="5">3x Moldorm Malleus (Rank 2 Monster Part)</td>
    </tr>
  </thead>
</table>
